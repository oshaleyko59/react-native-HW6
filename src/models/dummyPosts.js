...
//https://firebasestorage.googleapis.com/v0/b/react-native-goit-1b74f.appspot.com/o/IMG1.jpg?alt=media&token=13d7f29b-c99a-4c13-ba33-ae6e82d66f6b
//gs://react-native-goit-1b74f.appspot.com/IMG2.jpg
...
const dummyPosts = [];
  ...
  for (i = 0; i < dummyGallery.length; i = i + 1) {
    ...
    for (i = 0; i < 5; i = i + 1){
      ...
      dummyPosts[0].comments[i] = new Comment(lorem.generateSentences(1), (i === 2)?"buniadir@gmail.com":"test@gmail.com", date);
    }
})();
